							...
							{gallery && gallery.length > 0 ? (
								<div className="img-gallery position-relative">
									...
									<div className="galley-content">
										...
										<Link
											href={`/gallery?category_id=${gallery[0]["category"]["id"]}`}
											className="arrow-link color-6"
										>
							...
							{gallery && gallery.length > 1 ? (
								<div className="img-gallery position-relative mt-3">
									...
									<div className="galley-content">
										...
										<Link
											href={`/gallery?category_id=${gallery[1]["category"]["id"]}`}
											className="arrow-link color-6"
										>
											<FaChevronRight size={14} />
										</Link>
							...
							<div className="col-lg-3">
								<div className="img-gallery position-relative">
									...
									<div className="galley-content">
										...
										<Link
											href={`/gallery?category_id=${gallery[2]["category"]["id"]}`}
											className="arrow-link color-6"
										>
											<FaChevronRight size={14} />
										</Link>
							...
							<div className="col-lg-6">
								<div className="img-gallery position-relative">
									...
									<div className="galley-content">
										...
										<Link
											href={`/gallery?category_id=${gallery[3]["category"]["id"]}`}
											className="arrow-link color-6"
										>
											<FaChevronRight size={14} />
										</Link>
